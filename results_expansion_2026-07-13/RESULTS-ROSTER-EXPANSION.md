...
**Status:** post-hoc-motivated, PRE-REGISTERED (`mt29_roster_expansion_PREREG-2026-07-13.md`), pending user sign-off. Frozen legacy-4 regression guard passed byte-exact before this run.
...
- **V2 (generational dissolution/reversal in the OMat generation):** NO-GENERATIONAL-EFFECT (honest null) — positive-anchored in 17/17 OMat-gen UIPs (frac 1.0), reversed in 0/17, null in 0/17.
- **V3 (formal between-generation permutation test):** observed gap in mean oxide-vs-halide interaction (MP − OMat) = -0.0193 (95% CI [-0.18323, 0.14301]), permutation p = 0.82862 [n_MP=16, n_OMat=17].
- **Shuffle-null hygiene:** 0/495 false positives (clean = yes).
- **OVERALL:** NO-GENERATIONAL-EFFECT (honest null)

## Multiplicity (included-UIP family)

- Full family (495 model×pair cells): CI-excl-0 388, BH-FDR(q=.05) 379, Holm(α=.05) 0 [Holm resolution-limited at n_boot=1000].
- Oxide-vs-halide subfamily (33 cells): CI-excl-0 33, BH-FDR 33, Holm 0.

## Roster

- Models converted: 44 (all MP-gen: 27, all OMat-gen: 17).
- Included UIPs after inclusion rule (≥50 called-stable/stratum, ≥0.99 coverage): 33 (16 MP-gen, 17 OMat-gen).
...
| orb_v2_omat | OMat | uip | yes | 0.0285 | +0.4396 | [+0.324, +0.550] | yes | oxide | 0.1609 |
