...
% FONTPOLISH 2026-07-18: Times (newtx) to match the TeX-Gyre-Termes figures (same
% unification as the JCP port).
\usepackage{newtxtext}
\usepackage{newtxmath}
\usepackage[margin=1in]{geometry}
\usepackage{amsmath} % amssymb dropped 2026-07-18: newtxmath provides it
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{tabularx}
\usepackage{siunitx}
...
reversal arose from an earlier prediction reconstruction and was corrected to $+0.64$. Scoping the claim: the
...
failure mode our integrity-verified, byte-identical reproduction is built to rule out. Ottomano
...
every credential-free WBM prediction file in the public Matbench Discovery release
...
published release integrity records (an automated verification pass, $44/44$ OK). The roster and
...
in the published Matbench Discovery prediction release --- GRACE-2L-MPtrj and SevenNet-0 --- contain a handful of
...
time). A superseded earlier arm reconstructed predictions for four models on a single RTX 4090D (24\,GB; measured
...
\paragraph{Reproducibility status.} Both Stage-1 and Stage-2 have now
...
(\url{https://github.com/PeterPonyu/uip-abstention-audit}) and archived at Zenodo under
DOI~\texttt{10.5281/zenodo.21130295}. The GitHub repository is public.
